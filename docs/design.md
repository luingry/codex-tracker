...
- Settings: header e footer fixos; somente o corpo é rolável. Os grupos mantêm ritmo vertical uniforme, labels de família, peso, tamanho e cor semântica compartilhados, checkboxes com respiro confortável entre marca e texto, campos legíveis nos dois temas e chevron óptico no seletor. O texto selecionado e os itens dos ComboBox herdam a cor de alto contraste do tema; o controle de destaque separa visualmente amostra, rótulo e hexadecimal; o caminho manual do Codex permanece colapsado e só é exibido como fallback da auto-detecção, enquanto Abrir log fica sempre acessível.
