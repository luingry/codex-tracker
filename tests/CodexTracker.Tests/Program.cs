...
Assert(agentListTemplate.Contains("HorizontalOffset=\"-149\" VerticalOffset=\"-10\"", StringComparison.Ordinal) && agentListTemplate.Contains("<Border Padding=\"15\" Background=\"Transparent\">", StringComparison.Ordinal) && agentListTemplate.Contains("x:Name=\"AgentListWrapper\" Width=\"288\" MaxHeight=\"350\" Padding=\"0\"", StringComparison.Ordinal) && agentListTemplate.Contains("<Border.Effect><DropShadowEffect BlurRadius=\"12\" ShadowDepth=\"3\" Opacity=\".28\" Color=\"#151A18\" /></Border.Effect>", StringComparison.Ordinal) && agentListTemplate.Contains("x:Name=\"AgentRow\" Margin=\"0\"", StringComparison.Ordinal) && agentListTemplate.Contains("<ContentPresenter Margin=\"0,8\" HorizontalAlignment=\"{TemplateBinding HorizontalContentAlignment}\" VerticalAlignment=\"{TemplateBinding VerticalContentAlignment}\" />", StringComparison.Ordinal) && agentListTemplate.Contains("<Border Margin=\"{Binding Indent}\" Padding=\"15,6\">", StringComparison.Ordinal), "agent wrapper keeps clearance for its blur and displaced shadow while each contiguous full-width row owns the former vertical breathing room, including hover and ripple coverage");
